...
if (file_exists('protected/sys/foxworldverifycodemain.temp.txt')) {

  $is = json_decode(file_get_contents('https://foxcloud.fcosma.it/api/world/get?host=' . $_SERVER["HTTP_HOST"]));
  if ($is->status == 200) {
?>
