...
if (file_exists('protected/sys/' . $user. 'fileEvidenziati.array')) {
  die(json_encode(array('status' => 200, 'presence' => true, 'evidenziati' => explode('[[FoxCloudEvidenziatiSeparator]]', file_get_contents('protected/sys/' . $user. 'fileEvidenziati.array')))));
} else {
